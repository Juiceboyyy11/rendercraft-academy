...
import { Play, Clock, Users, Star, Lock, Download } from 'lucide-react'
...
export default function AcademyPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="animate-pulse text-white/50">Loading courses...</div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-black">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="text-center group">
                ...
                <p className="text-white/70">Learn at your own pace with lifetime access to course materials.</p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-white/70">Advance your career with skills that are in high demand.</p>
              </div>
            </div>
      ...
      {/* Courses Section */}
      <section id="courses" className="py-16 sm:py-20 bg-black px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto">
          {/* Section Header */}
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">
                ...
                <div key={course.id} className="group">
                  <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden transition-all duration-300 hover:bg-white/8 hover:border-white/20 hover:-translate-y-1">
                    ...
                    <div className="p-6">
                      ...
                      <div 
                        className="text-white/60 text-sm leading-relaxed mb-4 prose prose-invert prose-sm max-w-none"
